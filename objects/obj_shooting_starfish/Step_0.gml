...
if(shooting == true){	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	if(shoot_cooldown < 1){	/// @DnDAction : YoYo Games.Loops.For_Loop
		...
		for(i = 0; i < 5; i += 1) {	/// @DnDAction : YoYo Games.Instances.Create_Instance
			...
			var star_shot = instance_create_layer(x + 0, y + 0, "instances_projectiles", obj_enemy_bullet_pink_mid);
			...
			/// @DnDInput : 2
			/// @DnDParent : 3124263D
			/// @DnDArgument : "expr" "36 + obj_shooting_starfish.image_angle + i * 72"
			/// @DnDArgument : "expr_1" "60"
			/// @DnDArgument : "var" "star_shot.direction"
			/// @DnDArgument : "var_1" "shoot_cooldown"
			star_shot.direction = 36 + obj_shooting_starfish.image_angle + i * 72;
			shoot_cooldown = 60;}
...
if(shooting == false){	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	/// @DnDArgument : "op" "1"
	/// @DnDArgument : "value" "5* base_speed"
	if(speed < 5* base_speed){	/// @DnDAction : YoYo Games.Movement.Set_Speed
		/// @DnDVersion : 1
		/// @DnDHash : 427A4BD7
		/// @DnDParent : 58D35D13
